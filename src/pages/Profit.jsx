...
export default function Profit() {
 ...
 function findProfit30() {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      if (
        ...
        if (profitPercentage < 30) {
          ...
          tempProfit.push({Title: data[i].title,
  ...
  function Buttons({ onClick }) {
    return (
      <>
        <button className="button" onClick={() => findProfit30()}>Less than 30%</button>
        <button className="button" onClick={() => findProfit50()}>50%</button>
        <button className="button" onClick={() => findProfitMore50()}>More than 50%</button>
      </>
    );
  }
  ...
  function ProfitScreen () {
    return (
      <>
        ...
        <h1>No Profit Data Available - Please Click a Profit Percentage Button</h1>
       )}
      </>
    );
  }
